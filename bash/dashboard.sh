        ...
        "overrides": [
          {
            "matcher": {
              "id": "byName",
              "options": "{__name__=\"node_thermal_zone_temp\", instance=\"node_exporter:9100\", job=\"node_exporter\", type=\"acpitz\", zone=\"0\"}"
            },
            "properties": [
              {
                "id": "displayName",
          ...
          },
          {
            "matcher": {
              "id": "byName",
              "options": "{__name__=\"node_thermal_zone_temp\", instance=\"node_exporter:9100\", job=\"node_exporter\", type=\"iwlwifi_1\", zone=\"2\"}"
            },
            "properties": [
              {
                "id": "displayName",
          ...
          },
          {
            "matcher": {
              "id": "byName",
              "options": "{__name__=\"node_thermal_zone_temp\", instance=\"node_exporter:9100\", job=\"node_exporter\", type=\"pch_wildcat_point\", zone=\"1\"}"
            },
            "properties": [
              {
                "id": "displayName",
          ...
          },
          {
            "matcher": {
              "id": "byName",
              "options": "{__name__=\"node_thermal_zone_temp\", instance=\"node_exporter:9100\", job=\"node_exporter\", type=\"x86_pkg_temp\", zone=\"3\"}"
            },
            "properties": [
              {
                "id": "displayName",
      ...
      "targets": [
        {
          ...
          "editorMode": "explain",
          "exemplar": false,
          "expr": "node_thermal_zone_temp{instance=\"node_exporter:9100\"}",
          "format": "time_series",
          "interval": "",
          "legendFormat": "__auto",
          "range": true,
